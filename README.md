...
A beta version of this feature is implemented via `workflows/Boltz/boltz_pipeline_wrapper_step_02_05_multimer_HC.sh` . Mind that in the multichain version some pyrosetta metrics are calculated differently. Alternatively, you can add glycines linkers (ex: seqA-GGGGSGGGGSGGGGSGGGGS-seqB) between the multichain protein and treat them as monomers.
