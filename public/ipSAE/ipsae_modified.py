...
if len(sys.argv) < 7:
    print("Usage for AF2:")
    print("   python ipsae.py <path_to_pae_json_file> <path_to_pdb_file> <pae_cutoff> <dist_cutoff> <model_type> <output_type>")
    print("   python ipsae.py RAF1_KSR1_scores_rank_001_alphafold2_multimer_v3_model_4_seed_003.json RAF1_KSR1_unrelaxed_rank_001_alphafold2_multimer_v3_model_4_seed_003.pdb 10 10 af2 pdb")
    print("")
    print("Usage for AF3:")
    print("   python ipsae.py <path_to_pae_json_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff> <model_type> <output_type>")
    print("   python ipsae.py fold_aurka_tpx2_full_data_0.json  fold_aurka_tpx2_model_0.cif 10 10 af3 cif")
    print("")
    print("Usage for Boltz1:")
    print("   python ipsae.py <path_to_pae_npz_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff> <model_type> <output_type>")
    print("   python ipsae.py pae_AURKA_TPX2_model_0.npz  AURKA_TPX2_model_0.cif 10 10 boltz1 cif")
    print("Model type can be one of af2, af3, or boltz1")
    print("Output type can be one of pdb or cif)")
    sys.exit(1)
...
#if ".pdb" in pdb_path:
if model_type=="af2":
    pdb_stem=pdb_path.replace(f".{output_type}","")
