...
${BOLTZ_PATH} predict ${INPUT_PATH} --out_dir ${OUTPUT_DIR} --recycling_steps ${RECYCLING_STEPS} --diffusion_samples ${DIFFUSION_SAMPLES} --output_format "pdb" --use_msa_server --write_full_pae	
